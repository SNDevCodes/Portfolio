...
(function ($) {
  ...
  h4_slider
    ...
    .on("translate.owl.carousel", function (e) {
      ...
      $(".h4_slider .owl-item")
        .eq(idx)
        .children(".ss_single_folio")
        .addClass("activeReady");
    });
  ...
  h6_slider
    ...
    .on("translated.owl.carousel", function (e) {
      var idx = e.item.index;
      $(".h6_full_screen_slider .owl-item .h6s_item").removeClass(
        "activeReady"
      );
      $(".h6_full_screen_slider .owl-item")
        .eq(idx)
        .children(".h6s_item")
        .addClass("activeReady");
    });
  ...
  if ($(".sidebar_menu").length > 0) {
    $(
      ".sidebar_menu ul li.menu-item-has-children > a, .menu_05 ul li.menu-item-has-children a:after"
    ).on("click", function (e) {
      e.preventDefault();
  ...
  $(window).on("load resize", function (e) {
    if ($(window).width() < 991) {
      ...
      $(".mobile_menu ul li.menu-item-has-children > span.submenu_toggler").on(
        "click",
        function () {
          var $this = $(this);
  ...
  $(".social_popup a")
    .on("mouseenter", function () {
      ...
      $(".pop_background .pb_social_bg, .popu_social_mod .pb_social_bg").css({
        "background-color": bg,
        opacity: 1,
        visibility: "visible",
      });
    ...
    holder.css({
      ...
      $(document)
        .on("mousemove", function (e) {
          cursor.hasClass("drox_block") ||
            holder.css({
              transform:
                "matrix(1, 0, 0, 1, " + e.clientX + ", " + e.clientY + ")",
            });
        })
        .on("mouseleave", function () {
        ...
        .on("mouseenter", function () {
          cursor.hasClass("drox_block") ||
            cursor.removeClass("drox_fade_coursor");
        }),
      $("a")
        .on("mouseenter", function () {
      ...
      fader.length &&
        fader
          .on("mouseenter", function () {
            cursor.hasClass("drox_block") ||
              cursor.addClass("drox_fade_coursor");
          })
          .on("mouseleave", function () {
            cursor.hasClass("drox_block") ||
              cursor.removeClass("drox_fade_coursor");
  ...
  if ($(".folio_05").length > 0) {
    $("body").append(
      '<div class="folio_tooltips_wrapper"><div class="ftw_titler"></div><div class="ftw_cater"></div></div>'
    );
      ...
      $this.on("mousemove", function (e) {
        ...
        $this
          .on("mouseenter", function () {
            ...
            $ftw_title_new.length && $ftw_title.html($ftw_title_new.html()),
              $ftw_cat_new.length && $ftw_cat.html($ftw_cat_new.html()),
              $ftw_holder.hasClass("fwt_is_active") ||
                $ftw_holder.addClass("fwt_is_active");
          })
          .on("mouseleave", function () {
            $ftw_holder.hasClass("fwt_is_active") &&
              $ftw_holder.removeClass("fwt_is_active");
          }),
        $(window).scroll(function () {
          $ftw_holder.hasClass("fwt_is_active") &&
            ($ftw_holder.offset().top < $this.offset().top ||
              $ftw_holder.offset().top >
